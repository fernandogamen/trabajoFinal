...
\thispagestyle{empty}
\begin{abstract}
El universo de Risk resulta ser demasiado amplio de tal forma que este proyecto busca una implementaci\'on sencilla basada en el algoritmo de \textit{Minimax} nativa de la teor\'ia de juegos.
\\
...
Explicar por que catalogamos al Risk c\'omo un juego de informaci\'on perfecta y por que hemos elegido esta implementaci\'on.
